...
object ReduceExample  extends App {
  ...
  def useCases(sc: SparkContext) = {
    ...
    val reduce1 = sc.parallelize(List((3, "1:Road"), (3, "2: Road"), (3, "3: Intersection"),
      (3, "5: Road"), (6, "4: Road"), (6, "5: Road"), (6, "6: Intersection"), (6, "7:Road")), 2)

    val res = reduce1.reduceByKey((value1, value2) => value1 + "," + value2).collect()
